...
export default function defineSkinHooks() {
  return {
    apply(ctx) {
      ...
      const VEIL_BY_THEME = {
        light: {
          'baoqing-den.jpg': 'rgba(242, 245, 242, 0.35)',
          'boat-song.jpg': 'rgba(242, 245, 242, 0.30)',
          'broken-bridge.jpg': 'transparent',
          'lantern-twilight.jpg': 'rgba(242, 245, 242, 0.20)',
          'linan-mist.jpg': 'transparent',
          'moonlight-cave.jpg': 'rgba(242, 245, 242, 0.40)',
          'snake-destiny.jpg': 'rgba(242, 245, 242, 0.40)',
          'snakes-meadow.jpg': 'rgba(242, 245, 242, 0.25)',
          'sunset-rooftop.jpg': 'rgba(242, 245, 242, 0.15)',
        },
        dark: {
          'baoqing-den.jpg': 'transparent',
          'boat-song.jpg': 'transparent',
          'broken-bridge.jpg': 'rgba(11, 19, 21, 0.25)',
          'lantern-twilight.jpg': 'transparent',
          'linan-mist.jpg': 'rgba(11, 19, 21, 0.25)',
