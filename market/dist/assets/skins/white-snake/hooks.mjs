  ...
  return {
    apply(ctx) {
      ...
      const BACKGROUNDS = [
        ...
        // ---《白蛇：浮生》名场面 ---
        { id: 'fusheng-wedding', label: '大婚良缘', file: 'fusheng-wedding.jpg' },
        { id: 'fusheng-bridge-umbrella', label: '断桥借伞', file: 'fusheng-bridge-umbrella.jpg' },
        { id: 'fusheng-bridge-meeting', label: '断桥初识', file: 'fusheng-bridge-meeting.jpg' },
        { id: 'fusheng-night-boat', label: '夜航幽月', file: 'fusheng-night-boat.jpg' },
        { id: 'fusheng-flight', label: '御风齐飞', file: 'fusheng-flight.jpg' },
        { id: 'fusheng-flute-sweet', label: '笛韵依偎', file: 'fusheng-flute-sweet.jpg' },
        { id: 'fusheng-lotus-boat', label: '荷塘画舫', file: 'fusheng-lotus-boat.jpg' },
        { id: 'fusheng-market-street', label: '市井烟火', file: 'fusheng-market-street.jpg' },
        { id: 'fusheng-umbrella-sea', label: '万伞如海', file: 'fusheng-umbrella-sea.jpg' },
        { id: 'fusheng-apothecary', label: '药铺温情', file: 'fusheng-apothecary.jpg' },
        { id: 'fusheng-window-rain', label: '临窗听雨', file: 'fusheng-window-rain.jpg' },
        { id: 'fusheng-willow-glance', label: '苏堤拂柳', file: 'fusheng-willow-glance.jpg' },
        { id: 'fusheng-spring-blossom', label: '烟波春晓', file: 'fusheng-spring-blossom.jpg' },
        { id: 'fusheng-flower-valley', label: '幽谷花海', file: 'fusheng-flower-valley.jpg' },
        { id: 'fusheng-bridge-mist', label: '断桥春霁', file: 'fusheng-bridge-mist.jpg' },
        { id: 'fusheng-kunlun', label: '昆仑雪巅', file: 'fusheng-kunlun.jpg' },
        { id: 'fusheng-green-snake', label: '青蛇凌波', file: 'fusheng-green-snake.jpg' },
        { id: 'fusheng-baoqing-opera', label: '宝青新貌', file: 'fusheng-baoqing-opera.jpg' },
        // ---《白蛇：缘起》经典名场面 ---
        { id: 'broken-bridge', label: '断桥烟雨', file: 'broken-bridge.jpg' },
        { id: 'broken-bridge-wide', label: '断桥远眺', file: 'broken-bridge-wide.jpg' },
        { id: 'boat-song', label: '何须问·舟行', file: 'boat-song.jpg' },
        { id: 'snakes-meadow', label: '青白并蒂', file: 'snakes-meadow.jpg' },
        { id: 'baoqing-den', label: '宝青奇坊', file: 'baoqing-den.jpg' },
        { id: 'sunset-rooftop', label: '浮生晚霞', file: 'sunset-rooftop.jpg' },
        { id: 'snake-destiny', label: '雪岭宿命', file: 'snake-destiny.jpg' },
        { id: 'linan-mist', label: '临安晴岚', file: 'linan-mist.jpg' },
        { id: 'moonlight-cave', label: '水月幽冥', file: 'moonlight-cave.jpg' },
        { id: 'lantern-twilight', label: '灯火天河', file: 'lantern-twilight.jpg' },
      ];
      ...
      const VEIL_BY_THEME = {
        light: {
          'baoqing-den.jpg': 'rgba(242, 245, 242, 0.20)',
          'boat-song.jpg': 'rgba(242, 245, 242, 0.20)',
          'broken-bridge-wide.jpg': 'transparent',
          'broken-bridge.jpg': 'transparent',
          'fusheng-apothecary.jpg': 'rgba(242, 245, 242, 0.20)',
          'fusheng-baoqing-opera.jpg': 'rgba(242, 245, 242, 0.20)',
          'fusheng-bridge-meeting.jpg': 'transparent',
          'fusheng-bridge-mist.jpg': 'transparent',
          'fusheng-bridge-umbrella.jpg': 'transparent',
          'fusheng-flight.jpg': 'transparent',
          'fusheng-flower-valley.jpg': 'rgba(242, 245, 242, 0.10)',
          'fusheng-flute-sweet.jpg': 'transparent',
          'fusheng-green-snake.jpg': 'transparent',
          'fusheng-kunlun.jpg': 'transparent',
          'fusheng-lotus-boat.jpg': 'transparent',
          'fusheng-market-street.jpg': 'transparent',
          'fusheng-night-boat.jpg': 'rgba(242, 245, 242, 0.20)',
          'fusheng-spring-blossom.jpg': 'transparent',
          'fusheng-umbrella-sea.jpg': 'transparent',
          'fusheng-wedding.jpg': 'rgba(242, 245, 242, 0.20)',
          'fusheng-willow-glance.jpg': 'transparent',
          'fusheng-window-rain.jpg': 'rgba(242, 245, 242, 0.20)',
          'lantern-twilight.jpg': 'transparent',
          'linan-mist.jpg': 'transparent',
          'moonlight-cave.jpg': 'rgba(242, 245, 242, 0.20)',
          'snake-destiny.jpg': 'rgba(242, 245, 242, 0.20)',
          'snakes-meadow.jpg': 'rgba(242, 245, 242, 0.15)',
          'sunset-rooftop.jpg': 'transparent',
        },
        dark: {
          'baoqing-den.jpg': 'transparent',
          'boat-song.jpg': 'transparent',
          'broken-bridge-wide.jpg': 'transparent',
          'broken-bridge.jpg': 'transparent',
          'fusheng-apothecary.jpg': 'transparent',
          'fusheng-baoqing-opera.jpg': 'transparent',
          'fusheng-bridge-meeting.jpg': 'transparent',
          'fusheng-bridge-mist.jpg': 'transparent',
          'fusheng-bridge-umbrella.jpg': 'transparent',
          'fusheng-flight.jpg': 'transparent',
          'fusheng-flower-valley.jpg': 'transparent',
          'fusheng-flute-sweet.jpg': 'transparent',
          'fusheng-green-snake.jpg': 'transparent',
          'fusheng-kunlun.jpg': 'transparent',
          'fusheng-lotus-boat.jpg': 'transparent',
          'fusheng-market-street.jpg': 'transparent',
          'fusheng-night-boat.jpg': 'transparent',
          'fusheng-spring-blossom.jpg': 'transparent',
          'fusheng-umbrella-sea.jpg': 'transparent',
          'fusheng-wedding.jpg': 'transparent',
          'fusheng-willow-glance.jpg': 'transparent',
          'fusheng-window-rain.jpg': 'transparent',
          'lantern-twilight.jpg': 'transparent',
          'linan-mist.jpg': 'transparent',
          'moonlight-cave.jpg': 'transparent',
          'snake-destiny.jpg': 'transparent',
          'snakes-meadow.jpg': 'transparent',
          'sunset-rooftop.jpg': 'transparent',
        },
      };
